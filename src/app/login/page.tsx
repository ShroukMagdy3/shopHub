      ...
      <div className="brand-card w-full max-w-md rounded-[34px] p-10 text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-full border border-black/10 bg-white py-3 font-black text-zinc-950 transition hover:bg-yellow-100"
            >
              <GoogleIcon />
